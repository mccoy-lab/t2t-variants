...
if (!(sample_id %in% c("CHM13", "GRCh38"))) {
  ...
  fwrite(ld, file = paste0("/scratch4/mschatz1/rmccoy22/rmccoy22/rare_haplotypes/output/", sample_id, "_", chromosome, "_h2_rare_haps.txt"),
         quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
